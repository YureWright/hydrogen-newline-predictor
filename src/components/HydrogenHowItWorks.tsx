      ...
      <div className="howitworks-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="howitworks-body">
          ...
          <Sec num="2" title="数据：来源与处理">
            <Sub title="2.1 数据来源">
              <Table head={["数据","来源","用途"]} rows={[
                ["实车 CAN（80 列）","两辆 H49 重卡 2026-08，60s×5504 条","速度、经纬度、氢气剩余量、目标构造"],
                ["海拔/坡度","terrarium DEM 瓦片（AWS S3，静态）","回填每点海拔，段内差分得坡度"],
                ["温度/风速/湿度/降水","Open-Meteo ERA5 历史再分析（免费）","按点×时刻回填历史天气"],
